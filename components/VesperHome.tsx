...
const T = {
  en: {
    ...
    menu: { home: "Home", about: "About", application: "Application", contact: "Contact", members: "Members" },
  ...
  es: {
    ...
    menu: { home: "Inicio", about: "Sobre Nosotros", application: "Solicitud", contact: "Contacto", members: "Miembros" },
  ...
  fr: {
    ...
    menu: { home: "Accueil", about: "À Propos", application: "Candidature", contact: "Contact", members: "Membres" },
